...
class claim_success :DialogFragment() {
    private var _binding: FragmentClaimSuccessBinding?= null
    private val binding get() = _binding!!
        ...
        // Inflate the layout for this fragment
                _binding = FragmentClaimSuccessBinding.inflate(inflater, container, false)
                return binding.root
    }
